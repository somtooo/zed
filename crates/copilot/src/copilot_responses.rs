...
// Todo: reasoning.encrypted_content might be useful for reasoning models like gpt 5
...
pub async fn stream_response(
    ...
    if is_streaming {
        ...
        // simulate streaming this makes the mapping of this functions return more straight-forward to handle if all callers assume it streams
        // Todo: Test non streaming works
        let mut body = String::new();
        response.body_mut().read_to_string(&mut body).await?;
