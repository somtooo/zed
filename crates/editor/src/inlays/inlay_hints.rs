...
pub struct LspInlayHintData {
    ...
    // TODO kb why here, not in the hover popover?
...
impl Editor {
    ...
    pub(crate) fn inlay_hint_to_accept(
        ...
        if cursor_changed && !cursor_hint.hints.is_empty() {
            ...
            // TODO kb is it needed? we should resolve on hover and visible range in the editor already!
    ...
    pub(crate) fn accept_inlay_hint_with_id(
        ...
        // TODO kb so no command-rich hints can be inserted?
        ...
        // TODO kb instead, spawn a task and wait for the resolve to complete, then apply asynchronously
                ...
                && !text_edits.edits.is_empty()
            {
                editor
                    .update_in(cx, |editor, window, cx| {
                        ...
                        // TODO kb this should have been checked way earlier
                            || editor.read_only(cx)
